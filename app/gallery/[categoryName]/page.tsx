                ...
                <div className="pt-20 pb-12">
                    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-8">
                        <div className="flex-1">
                            {/* Badge */}
                            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full text-[#7CBD1E] font-bold text-sm mb-6 shadow-lg border border-white/50">
                                📷 Gallery Collection
                            </div>
                            ...
                            <div className="flex flex-wrap gap-6 mb-8">
                                <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full shadow-md">
                                    ...
                                    <span className="font-medium text-gray-700">{galleryInfo.date}</span>
                                </div>
                                <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full shadow-md">
                                    <span className="text-2xl">📍</span>
                                    <span className="font-medium text-gray-700">{galleryInfo.location}</span>
                                </div>
                                <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full shadow-md">
                                    <span className="text-2xl">👥</span>
                                    <span className="font-medium text-gray-700">{galleryInfo.participants}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <button
                            onClick={() => router.push('/')}
                            className="bg-gradient-to-r from-[#7CBD1E] to-[#F1F864] text-white px-6 py-3 rounded-full font-bold flex items-center gap-2 hover:shadow-lg transform hover:scale-105 transition-all duration-300 shadow-md"
                        >
                        ...
                        {galleryInfo.images.map((src, index) => (
                            ...
                            >
                                <div className="relative aspect-square overflow-hidden">
                                    ...
                                    {/* Photo Number Badge */}
                                    <div className="absolute top-3 left-3 bg-[#7CBD1E] text-white px-2 py-1 rounded-full text-xs font-bold">
                                        {index + 1}
                                    </div>
                                </div>
                            </a>
